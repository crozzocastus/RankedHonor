  ...
  return (
    <div className="relative h-full w-full bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {post.type === 'live' && (
          <div className="relative w-full h-full max-w-2xl mx-auto">
            ...
            <div className="absolute top-6 right-6 bg-black/60 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
              <span className="text-white font-semibold text-sm">{post.viewerCount?.toLocaleString()} assistindo</span>
            </div>
          </div>
        )}
        ...
        {post.type === 'text' && (
          <div className="relative w-full h-full max-w-2xl mx-auto flex items-center justify-center p-8">
            <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl p-12 rounded-2xl border border-gray-700/50 shadow-2xl">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3 flex-1">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="font-bold text-white">{post.creator.username}</h3>
            ...
            <button
              ...
              className={`ml-3 px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-200 flex items-center gap-2 whitespace-nowrap ${
                isFollowing
