    ...
    <div className="space-y-6 sticky top-24">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <select className="bg-gray-800 border border-gray-700 rounded-lg px-3 py-1 text-gray-300 text-sm">
            <option>Todas</option>
          ...
          {topPlayers.map((player) => {
            ...
            return (
              ...
              >
                ...
                <div className={`text-sm ${player.trend === 'up' ? 'text-green-500' : 'text-red-500'}`}>
                  {player.trend === 'up' ? '▲' : '▼'}
                </div>
              </div>
            );
