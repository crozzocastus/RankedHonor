...
const getPositionIcon = (position: number) => {
  switch (position) {
    ...
    case 3:
      return <Award className="h-6 w-6 text-orange-700" />;
    default:
      return null;
  }
};
...
export function RankingsSection() {
  ...
  return (
    <section id="rankings" className="bg-black py-16">
        ...
        <div className="overflow-hidden rounded-xl border border-gray-800 bg-gray-900">
          ...
          <div className="divide-y divide-gray-800">
            {players.map((player) => (
              <div
                key={player.position}
                className={`grid grid-cols-[80px_1fr_200px_150px_120px_120px] gap-4 px-6 py-4 transition-colors hover:bg-gray-800/30 ${
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-gradient-to-br from-orange-500 to-red-600">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {player.trend === "stable" && <Minus className="h-4 w-4 text-gray-500" />}
                </div>
